...
export class AuthService {
  ...
  constructor(
    ...
    private getAuthData(): any {
      const token = localStorage.getItem('token_interFriendWeb');
      const userId = localStorage.getItem('userId_interFriendWeb');
      const email = localStorage.getItem('email_interFriendWeb');
      const name = localStorage.getItem('name_interFriendWeb');
      const profile_image = localStorage.getItem('profileImage_interFriendWeb');
      const profile_image_thumb = localStorage.getItem('profileImageThumb_interFriendWeb');
      const group_id = localStorage.getItem('groupId_interFriendWeb');
      if (!token) {
        return;
      }
